...
const CharacterBuilder = () => {
  ...
  const generateLore = async () => {
    ...
    setTimeout(() => {
      setGeneratedLore(
        `${name} is a legendary figure whose ${personality.wisdom[0] > 70 ? "wisdom" : "courage"} is spoken of in whispers across the realm. ` +
        `Born during the ${name.includes("Storm") ? "Great Tempest" : "Age of Shadows"}, they mastered the arts of ${abilities[0] || "ancient magic"}. ` +
        `With traits like ${traits[0] || "mysterious origins"}, they have become a pivotal force in shaping the destiny of their world.`
      );
